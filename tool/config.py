...
ROBOT_PATH = os.path.join(ROOT_PATH, 'robot/cpp')
CONF_CODE_PATH_C = os.path.join(ROBOT_PATH, 'conf')
CONF_BIN_PATH_C = os.path.join(ROBOT_PATH, 'data')
CONF_CSV_PATH_C = os.path.join(ROBOT_PATH, 'csv')
...
EXP_PROTO_PATH_C = os.path.join(ROBOT_PATH, 'proto')
